...
Video of installing a new CF disk using TeraTerm macro, newCF.ttl.

Updated TeraTerm macro that installs CP/M 2.2, CP/M 3, HiTech C, Zork, and Startrek edition of SCMonitor. To run the macro, unzip the files into c:\teraterm\zrcc folder and run the macro file “newCF.ttl” in TeraTerm
...
- Send the serial loader as binary file (In TeraTerm, check the “Binary” box), the console will respond with
```
ZRCC Loader v0.1
